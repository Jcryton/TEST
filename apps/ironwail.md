...
screenshots:
- https://raw.githubusercontent.com/andrei-drexler/ironwail/Linux/AppImage/Img/ironwail_1.png

authors:
  - name: Jcryton
    url: https://github.com/Jcryton

links:
  - type: GitHub
    url: Jcryton/TEST
  - type: Download
    url: https://github.com/Jcryton/TEST/releases
  - type: Download
    url: ironwail.mirrorlist
...
desktop:
  ...
  AppImageHub:
    X-AppImage-Signature: 'directory ''/home/runner/.gnupg'' created keybox ''/home/runner/.gnupg/pubring.kbx''
      created Signature made Thu Feb 13 12:51:51 2025 UTC                using RSA key
...
appdata:
  ...
  - default: true
    ...
    thumbnails: []
    source-image:
      url: https://raw.githubusercontent.com/andrei-drexler/ironwail/Linux/AppImage/Img/ironwail_1.png
      lang: C
  - caption:
      C: Ironwail screenshot 2
    thumbnails: []
    source-image:
      url: https://raw.githubusercontent.com/andrei-drexler/ironwail/Linux/AppImage/Img/ironwail_2.png
      lang: C
  - caption:
      C: Ironwail screenshot 3
    thumbnails: []
    source-image:
      url: https://raw.githubusercontent.com/andrei-drexler/ironwail/Linux/AppImage/Img/ironwail_3.png
      lang: C
  - caption:
      C: Ironwail screenshot 4
    thumbnails: []
    source-image:
      url: https://raw.githubusercontent.com/andrei-drexler/ironwail/Linux/AppImage/Img/ironwail_4.png
      lang: C
  Releases:
  - version: 0.8.0
